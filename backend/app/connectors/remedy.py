"""Remedy ITSM connector — placeholder for real implementation."""
...
class RemedyConnector(TicketConnector):
    """Remedy ITSM connector — requires real Remedy API integration."""

    def __init__(self, base_url: str = "", token: str = "", project: str = ""):
        self.base_url = base_url.rstrip("/") if base_url else ""
        self.token = token
        self.project = project
        logger.info("remedy_connector_initialized", base_url=self.base_url)

    async def get_ticket(self, ticket_id: str) -> Dict:
        raise NotImplementedError("Remedy connector: real API integration pending")
